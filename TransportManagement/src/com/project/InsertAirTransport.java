...
/**
 * Servlet implementation class InsertAirTransport
 */
@WebServlet("/InsertAirTransport")
public class InsertAirTransport extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
       ...
       String button = request.getParameter("s5");
		...
		PreparedStatement ps=c1.prepareStatement("insert into airtransport values(?,?,?,?,?,?,?)");
