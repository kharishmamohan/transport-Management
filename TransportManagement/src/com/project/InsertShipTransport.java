...
/**
 * Servlet implementation class InsertShipTransport
 */
@WebServlet("/InsertShipTransport")
public class InsertShipTransport extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String button = request.getParameter("s4");
		...
		PreparedStatement ps=c1.prepareStatement("insert into shiptransport values(?,?,?,?,?,?,?)");
