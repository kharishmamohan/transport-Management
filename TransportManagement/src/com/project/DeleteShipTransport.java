...
/**
 * Servlet implementation class DeleteShipTransport
 */
@WebServlet("/DeleteShipTransport")
public class DeleteShipTransport extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	 ...
	 if(button.equals("delete")) {
			...
			try {
				...
				PreparedStatement ps =c1.prepareStatement("delete from shiptransport where from_location=?");
